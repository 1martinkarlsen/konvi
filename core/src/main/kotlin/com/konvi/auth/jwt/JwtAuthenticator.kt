 ...
 * the implementation with [com.konvi.auth.Authenticator] to enable JWT authentication.
 *
...
/** Default binding used when no JWT [com.konvi.auth.Authenticator] is provided. Rejects everything. */
