 ...
 * implementation with [com.konvi.auth.Authenticator] to enable basic authentication.
 */
...
/** Default binding used when no [com.konvi.auth.Authenticator] is provided. Rejects everything. */
